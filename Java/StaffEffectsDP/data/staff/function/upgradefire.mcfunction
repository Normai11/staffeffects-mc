...
summon item ~ ~ ~ {Item:{id:"minecraft:stick",count:1,components:{"item_name":"Staff of Uninflammability","enchantment_glint_override":true,"rarity": "epic","minecraft:custom_data":{"tag":"stafffiresuper"},"item_model":"stafffiresuper","max_stack_size":1}}}
