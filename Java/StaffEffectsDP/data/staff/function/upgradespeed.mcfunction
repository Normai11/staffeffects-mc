...
summon item ~ ~ ~ {Item:{id:"minecraft:stick",count:1,components:{"item_name":"Staff of Blurs","enchantment_glint_override":true,"rarity": "epic","minecraft:custom_data":{"tag":"staffspeedsuper"},"item_model":"staffspeedsuper","max_stack_size":1}}}
