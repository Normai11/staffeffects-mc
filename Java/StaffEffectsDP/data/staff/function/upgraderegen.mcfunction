...
summon item ~ ~ ~ {Item:{id:"minecraft:stick",count:1,components:{"item_name":"Staff of Recovery","enchantment_glint_override":true,"rarity": "epic","minecraft:custom_data":{"tag":"staffregensuper", "stafftype":"regen"},"item_model":"staffregensuper","max_stack_size":1}}}
