...
summon item ~ ~ ~ {Item:{id:"minecraft:enchanted_book",count:1,components:{"item_name":"Imbued Upgrade Rune","enchantment_glint_override":true,"rarity": "rare","minecraft:custom_data":{"tag":"imbuedRuneFire"},"item_model":"imbuedrune","lore":[{"text":"The tablet glows bright. Cannot upgrade anything.","color":"light_purple"}]}}}
