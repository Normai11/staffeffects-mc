...
summon item ~ ~ ~ {Item:{id:"minecraft:stick",count:1,components:{"item_name":"Staff of Brawn","enchantment_glint_override":true,"rarity": "epic","minecraft:custom_data":{"tag":"staffstrengthsuper"},"item_model":"staffstrengthsuper","max_stack_size":1}}}
