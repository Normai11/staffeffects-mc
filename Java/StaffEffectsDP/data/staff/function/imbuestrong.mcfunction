...
summon item ~ ~ ~ {Item:{id:"minecraft:enchanted_book",count:1,components:{"item_name":"Imbued Upgrade Rune","enchantment_glint_override":true,"rarity": "rare","minecraft:custom_data":{"tag":"imbuedRuneStrength"},"item_model":"imbuedrune","lore":[{"text":"The tablet glows bright. Imbued with Strength.","color":"light_purple"}]}}}
